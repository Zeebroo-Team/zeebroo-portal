...
<div class="layout">
    <aside class="sidebar">
        ...
        <nav class="menu">
            <a href="{{ route('dashboard') }}" class="active"><i class="fa fa-gauge-high"></i><span>Overview</span></a>
            @if(auth()->user()->hasRole('admin'))
                <a href="{{ route('admin.panel') }}"><i class="fa fa-user-shield"></i><span>Admin Panel</span></a>
            @endif
        </nav>
    </aside>
    <main class="content">
        <div class="navbar">
            <div>
                ...
                <div class="navmeta">Welcome, {{ auth()->user()->name }}</div>
            </div>
            <div class="nav-right">
...
<script>
    ...
    // Preserve selected dashboard theme.
    const savedTheme = localStorage.getItem('ui_theme') || document.documentElement.getAttribute('data-theme') || 'night';
